 ...
 *
 * Controllers can attach .statusCode and .code to any thrown Error:
 *   const err = new Error('Cargo weight exceeds vehicle capacity');
 *   err.statusCode = 400;
...
/** Helper to build a structured API error and pass it to next(). */
